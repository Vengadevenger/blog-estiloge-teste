...
const POSTS = [
  ...
  },
  {
    ...
    date: "2026-07-14",
    image: "/images/blog/como-consertar-bola-furada.jpg",
    heroImage: "/images/blog/como-consertar-bola-furada-hero.jpg",
    author: "Cola Bola",
    readTime: "4 min",
...
<p>Sua bola aposentada no canto da área de serviço provavelmente está a um furo de um milímetro de voltar pra pelada. Veja como funciona em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-13",
    image: "/images/blog/vazamento-no-bico-da-bola.jpg",
    heroImage: "/images/blog/vazamento-no-bico-da-bola-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>Antes de aposentar a bola que murcha sozinha, faça o teste do detergente no bico. Se a bolha crescer, o conserto está a 2 minutos de distância. Veja como funciona em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-12",
    image: "/images/blog/super-bonder-bola-furada.jpg",
    heroImage: "/images/blog/super-bonder-bola-furada-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>A super cola da gaveta é de graça, e custa uma bola de R$ 100 quando convence você de que furo não tem conserto. Antes de aposentar a sua, veja o conserto por dentro em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-11",
    image: "/images/blog/bola-murchando-sozinha.jpg",
    heroImage: "/images/blog/bola-murchando-sozinha-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>Antes da próxima bola nova, gaste cinco minutos com o balde e o detergente. Na maioria das vezes, a bola murcha está a 2 minutos de conserto. O passo a passo completo está em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-10",
    image: "/images/blog/vale-a-pena-consertar-bola.jpg",
    heroImage: "/images/blog/vale-a-pena-consertar-bola-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>Na próxima bola furada, faça a conta antes de ir pra loja: R$ 36,90 e 2 minutos de um lado, R$ 100 ou mais do outro. O passo a passo do conserto está em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-09",
    image: "/images/blog/camara-de-ar-na-bola.jpg",
    heroImage: "/images/blog/camara-de-ar-na-bola-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>A câmara de bicicleta teve seu tempo de herói da várzea. Pra bola de hoje, existe conserto que devolve a bola de ontem. Veja como funciona em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-08",
    image: "/images/blog/cola-para-bola-funciona-em-qualquer-bola.jpg",
    heroImage: "/images/blog/cola-para-bola-funciona-em-qualquer-bola-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>Antes de comprar, olhe a sua bola com os dois critérios deste guia: câmara inflável e furo de perfuração. Batendo os dois, o conserto está a 2 minutos de distância, em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    category: "Conserto de bola",
    date: "2026-07-07",
    image: "/images/blog/como-consertar-bola-de-volei.jpg",
    heroImage: "/images/blog/como-consertar-bola-de-volei-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>Uma bola de vôlei de mais de R$ 200, com o toque que o grupo inteiro já conhece, volta pro jogo por R$ 36,90. Antes de aposentar a sua, veja o conserto em <strong>colabola.com.br</strong>.</p>
  ...
  },
  {
    ...
    date: "2026-07-06",
    image: "/images/blog/conserto-de-bola-escolinha.jpg",
    heroImage: "/images/blog/conserto-de-bola-escolinha-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
...
<p>Antes do próximo pedido de reposição, faça o inventário do canto das bolas furadas. É provável que tenha um mês de treino parado ali, esperando 2 minutos de conserto cada. Os frascos e o passo a passo estão em <strong>colabola.com.br</strong>.</p>
  ...
  {
    id: 12,
    slug: "furo-grande-na-bola",
    title: "Furo grande ou corte na bola: o que tem conserto e o que não tem",
    excerpt: "Nem todo estrago em bola tem a mesma sentença. Este guia separa o furo que se recupera do corte que aposenta a bola, sem promessa e sem enrolação.",
    category: "Conserto de bola",
    date: "2026-07-05",
    image: "/images/blog/furo-grande-na-bola.jpg",
    heroImage: "/images/blog/furo-grande-na-bola-hero.jpg",
    author: "Cola Bola",
    readTime: "3 min",
    metaTitle: "Furo Grande na Bola Tem Conserto? | Cola Bola",
    metaDescription: "Furo grande, corte e rasgo na bola: veja o que a vedação interna recupera, o que não tem volta e como diagnosticar o estrago da sua bola em casa.",
    content: `
<p>Existem duas bolas furadas bem diferentes escondidas na mesma frase. A primeira pegou um espinho na grama e tem um furo de milímetro que ninguém acha sem mergulhar ela num balde. A segunda raspou num portão de ferro e tem um corte visível, com o revestimento aberto.</p>

<p>Quem pesquisa conserto de bola encontra respostas que tratam as duas como se fossem o mesmo caso. Não são. Uma tem conserto que dura anos, a outra não tem conserto que preste, e saber diferenciar as duas em casa evita gastar dinheiro nas duas direções erradas: jogar fora a bola que tinha volta, ou insistir na bola que já foi.</p>

<p>Este guia separa os casos com a régua que importa: o que aconteceu com a estrutura da bola.</p>

<h2>A régua: perfuração ou abertura</h2>

<p>A bola inflável funciona porque a câmara de borracha segura o ar e o revestimento segura a forma. Todo estrago cai num dos dois times:</p>

<ul>
<li><strong>Perfuração:</strong> um objeto fino atravessou revestimento e câmara e saiu. Espinho, prego, agulha, farpa, caco de vidro pequeno. O material em volta do furo continua íntegro e no lugar.</li>
<li><strong>Abertura:</strong> o material se rompeu e abriu. Corte de objeto afiado, rasgo em portão ou grade, revestimento descolando, costura estourada, câmara rasgada por dentro. Aqui o dano é na estrutura, não num ponto.</li>
</ul>

<p>Perfuração tem conserto. Abertura não tem conserto honesto.</p>

<h2>Por que perfuração se recupera</h2>

<p>No furo de perfuração, o problema é um canal minúsculo por onde o ar escapa. A vedação interna líquida, injetada pela válvula, se espalha por dentro da câmara e fecha esse canal pelo lado de dentro, onde a pressão da bola firma a vedação em vez de expulsá-la. O material da bola, que está íntegro, continua fazendo o trabalho estrutural dele.</p>

<p>Isso vale inclusive pra furo de prego mais grosso: se o objeto entrou e saiu sem rasgar, o canal fecha. Em bola de society e futsal, de revestimento mais grosso, a aplicação pode ser feita direto pelo furo, reforçando a vedação naquele ponto.</p>

<h2>Por que corte e rasgo não se recuperam</h2>

<p>Na abertura, o ar que escapa é o menor dos problemas. Com o revestimento rompido, a pressão interna encontra um ponto fraco estrutural e trabalha nele a cada calibrada e a cada chute, esticando o rasgo. Cola nenhuma devolve resistência estrutural a material rompido: dá pra tampar o buraco e a bola até segura ar parada, mas o primeiro jogo reabre tudo, geralmente maior.</p>

<p>O mesmo raciocínio vale pra costura estourada e pra bola com o revestimento descolando em placas. O diagnóstico honesto nesses casos é troca, e o dinheiro do conserto fica guardado pra bola seguinte.</p>

<h2>Como diagnosticar a sua em casa</h2>

<ul>
<li><strong>1.</strong> Olhe e passe a mão. Corte visível, aba levantada ou material aberto: caso de abertura, sem conserto.</li>
<li><strong>2.</strong> Nada visível? Calibre e mergulhe no balde. Uma fileira de bolhas num ponto só: perfuração, tem conserto.</li>
<li><strong>3.</strong> Bolhas em vários pontos ao mesmo tempo: material ressecado chegando ao fim, caso de troca.</li>
<li><strong>4.</strong> Bolha só no bico: vazamento de válvula, o conserto mais simples de todos.</li>
</ul>

<h2>O conserto certo pro caso certo</h2>

<p>O Cola Bola resolve os casos de perfuração e de bico: kit de R$ 36,90, aplicação pela válvula em cerca de 2 minutos, bolas de campo, society, futsal, vôlei, basquete e futevôlei. Uma bola de R$ 100 ou mais com furo de espinho volta pro jogo no mesmo dia.</p>

<p>E quando o diagnóstico der abertura, a resposta certa é a que você leu aqui: não compre conserto nenhum, nem o nosso. Guarde o dinheiro pra bola nova e proteja ela do portão que cortou a anterior. O teste do balde e o passo a passo do conserto estão em <strong>colabola.com.br</strong>.</p>
    `,
  },
];
